...
database = 'Cinefilx'  # Name of your Northwind database
use_windows_authentication = False  # Set to True to use Windows Authentication
username = 'sa'  # Specify a username if not using Windows Authentication
password = 'f4d238ea'  # Specify a password if not using Windows Authentication
...
# connection.commit()
    ...
    def insert_order_details(self, order_id):
        ...
        for row in range(num_rows):
            ...
            sql_query = "INSERT INTO OrderDetails ([ProductID], [UnitPrice], [Quantity], [Discount] VALUES (?, ?, ?, ?))"
            # Execute the SQL query with parameter values
